...
def load_data(file_name):
    ...
    if file_name == "notre_dame":
        ...
        image1_file = "../data/Fami/Fami_1.jpg"
        image2_file = "../data/Fami/Fami_2.jpg"
        eval_file = "../data/Fami/FamiEval.mat"
    elif file_name == "man":
        image1_file = "../data/Man/Man_1.jpg"
        image2_file = "../data/Man/Man_2.jpg"
    elif file_name == "singer":
        image1_file = "../data/Singer/Singer_1.jpg"
        image2_file = "../data/Singer/Singer_2.jpg"
